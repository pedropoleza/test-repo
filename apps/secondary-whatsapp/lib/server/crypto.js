/**
 * AES-256-GCM helpers para criptografar tokens em repouso.
 *
 * Chave: TOKEN_ENCRYPTION_KEY na Vercel — base64 de 32 bytes.
 * Geração:  node -e "console.log(require('crypto').randomBytes(32).toString('base64'))"
 *
 * Formato do ciphertext: base64( iv(12) || ciphertext || authTag(16) )
 */
